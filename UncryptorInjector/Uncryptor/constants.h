...
#include <ntimage.h>
	enum UNCRYPT_DLL_LOAD_FLAGS
	{
		...
		UNCRYPT_DLL_LOAD_KERNEL32_DLL = 0x0001,
		UNCRYPT_DLL_LOAD_NTDLL_32BIT_DLL = 0X002,
		UNCRYPT_DLL_LOAD_ADVAPI_64BIT_DLL = 0x004,
		UNCRYPT_DLL_LOAD_KERNELBASE_DLL = 0x0008,
		UNCRYPT_DLL_LOAD_UNCRYPTOR = 0x0010
	};
	...
	{ RTL_CONSTANT_STRING(L"\\System32\\kernel32.dll"), UNCRYPT_DLL_LOAD_KERNEL32_DLL,FALSE},
	{ RTL_CONSTANT_STRING(L"\\System32\\ntdll.dll"), UNCRYPT_DLL_LOAD_NTDLL_32BIT_DLL,FALSE },
	{ RTL_CONSTANT_STRING(L"\\System32\\advapi.dll"), UNCRYPT_DLL_LOAD_ADVAPI_64BIT_DLL,TRUE },
	{RTL_CONSTANT_STRING(L"\\System32\\KernelBase.dll"), UNCRYPT_DLL_LOAD_KERNELBASE_DLL,FALSE } // need for calls from kernel32.dll
	};

	UNCRYPT_DLL_DESCRIPTOR DLL_UNCRYPTOR = {
		RTL_CONSTANT_STRING(L"UncryptorDLL.dll"), UNCRYPT_DLL_LOAD_UNCRYPTOR
	};
	NTKERNELAPI
		PVOID
		NTAPI
